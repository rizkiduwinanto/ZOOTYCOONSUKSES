...
package virtualzoo.animal.flyanimal.bangau;
 ...
 * @version 3.0
 */
public class Bangau extends FlyAnimal {
  /** Constructor.
    ...
    */
  public Bangau(int x, int y, float beratHewan, boolean isBuas) {
    loc = new Point();
    loc.setPoint(x,y);
  ...
  public void interact() {
    System.out.println("Bangau: Wkaktktktktktkk Wkaattktktktk");
  }
}
