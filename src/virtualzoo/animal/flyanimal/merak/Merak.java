...
package virtualzoo.animal.flyanimal.merak;
 ...
 * @version 3.0
 */
public class Merak extends FlyAnimal {
  /** Constructor.
   * Menciptakan hewan Merak dan diletakkan pada titik (x,y)
   ...
   */
  public Merak(int x, int y, float beratHewan, boolean isBuas) {
    loc = new Point();
    loc.setPoint(x, y);
